...
dat <- read_csv("~/temp/BUSTED-SRV/med_Sim_12_13_17_processed.csv")
...
```{r}
dat %>% ggplot()+ geom_histogram(aes(srv.alpha.1.rate), fill = 'blue', alpha = 0.5) + geom_vline(aes(xintercept = mean(dat$True.alpha.1.value)))+ facet_grid(~Sites, scales = "free") 

dat %>% ggplot()+ geom_histogram(aes(srv.alpha.1.prop), fill = 'blue', alpha = 0.5) + geom_vline(aes(xintercept = mean(dat$True.alpha.1.prop)))+ facet_grid(~Sites, scales = "free") 

```
```{r}
dat %>% ggplot()+ geom_histogram(aes(srv.alpha.2.rate), fill = 'blue', alpha = 0.5) + geom_vline(aes(xintercept = mean(dat$True.alpha.2.value)))+ facet_grid(~Sites, scales = "free") 

dat %>% ggplot()+ geom_histogram(aes(srv.alpha.2.prop), fill = 'blue', alpha = 0.5) + geom_vline(aes(xintercept = mean(dat$True.alpha.2.prop)))+ facet_grid(~Sites, scales = "free") 


```

```{r}
dat %>% ggplot()+ geom_histogram(aes(srv.alpha.3.rate), fill = 'blue', alpha = 0.5) + geom_vline(aes(xintercept = mean(dat$True.alpha.3.value)))+ facet_grid(~Sites, scales = "free") 
